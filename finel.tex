...
\end{align}
%
where $r_f$ specifies the fibre radius and $k$ is so called Kozeny
...
$T$ is the temperature in Kelvins, which is controlled in the
...
protocol is followed.  The initial temperature $T_0 = 30$\degree C is
increased during $30$ minutes up to the temperature of
$T_f = 107.222$\degree C at which value it stays for another half an
...
forward Euler solver and time step size of $\dt = 60$~s.
